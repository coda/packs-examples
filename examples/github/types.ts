// These are the allowable values for the `event` field of a pull request
// review API request as dodcumented by GitHub:
...
// The valid values you can pass in the `state` filter parameter when
// listing PRs.
...
// Below are types for GitHub object responses. These only include the
// subset of fields we
